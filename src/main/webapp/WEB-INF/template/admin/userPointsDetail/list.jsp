            ...
            <div class="box-wrap">
                ...
                <div class="l-list">
					...
					<i class="arrow"></i></div>
                            ...
                            <input name="selectContent" type="text" id="txtKeywords" class="keyword" value="${userPointsDetail.selectContent}" placeholder="请输入" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable table">
            ...
            <c:forEach var="list" items="${page.list}" varStatus="i">
              <tr>
                    ...
                    <td align="center">${list.changePoints}</td>
                    <td align="center">${list.currentPoints}</td>
