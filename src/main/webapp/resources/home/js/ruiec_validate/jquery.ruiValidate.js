		...
		initForm: function (user_options) {
            ...
            */
		    rui_Validate_options.FormObj.find("." + rui_Validate_options.SubBtn + " , input[type='submit']").eq(0).click(function () {
		        ...
		        if ((rui_Validate_options.Frequent != undefined && rui_Validate_options.Frequent != false) && (_theState == undefined || _theState == "true")) {
		            //频繁点击
		...
		Subvalidation: function (rui_Validate_options, obj) {
		    ...
		    rui_Validate_options.FormObj.find("*[isNot]").each(function () {
		        ...
		        if (_result_cont!=null &&_result_cont.length < 1) {
		            ...
		            if (_theIsNot == true || _theIsNot == "true") {
		                ...
		                var  theVerify = $(this).attr("verify");	//验证
		                if (typeof theVerify != "undefined" && theVerify == "isAgree") {
		                    if (!$(this).is(":checked")) {
		                        var _theMessage = $(this).attr("msg") == undefined ? "请先同意协议" : $(this).attr("msg");
		                        if (typeof layer != "undefined") {
		                            layer.msg(_theMessage, { icon: 2 });
		                            var theObj = { statue: false, obj: $(this), msg: '' };
		                            _result_cont.push(theObj);
		                        }
		                    } 
		                }  
		    ...
		    if (_result_cont.length < 1) {
		        ...
		        if (theFormObjUrl != "" && theFormObjUrl != undefined) {  //如果提交是以 AJAX 提交 则执行一下 回调函数 
		            ...
		            if (rui_Validate_options.FormObj.attr("id") != undefined) { 
		        ...
		        function formSuccess2(data) {
		            ...
		            rui_Validate_options.CallBack(data);
		        }
