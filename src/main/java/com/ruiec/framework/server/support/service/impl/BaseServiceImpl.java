...
public  class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	@Override
	@Transactional(readOnly=true)
	public T get(ID id, java.util.Set<String> initPathSet, Fetch ...fetchs) {
		if(id == null){
			return null;
		}
	...
	@Override
	@Transactional(readOnly=true)
	public List<T> getByIds(ID[] ids, java.util.Set<String> initPathSet, Fetch ...fetchs){
		if(ids == null || ids.length == 0){
			return new ArrayList<T>();
		}
	...
	@Override
	@Transactional
	public int deleteCascade(ID id) {
		Assert.notNull(id);
	...
	@Override
	@Transactional
	public int deleteCascade(ID[] ids) {
		Assert.notEmpty(ids);
		int count = 0;
		for(ID id : ids){
