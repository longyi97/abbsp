...
public class CommonParam {
	...
	public static final String SESSION_ADMIN_USER = "session_admin_user";//登录后台用户标识key
	...
	public static final int STATISTIC_STAR_DATE = 2011;//统计年份数组开始年份
	
	public static final int DEFER_REMIND_TIME = 12;//延期提前提醒时间(单位：时)
