...
/**
  ...
  */
	...
	public Message(Type type, String message, String url) {
		this.type = type;
		this.message = message;
		this.url = url;
	}
	...
	public static Message info(String message, String url) {
		return new Message(Type.info, message, url);
	}

	public static Message info(String status, String msg, String url) {
		return new Message(status, msg, url);
	}

	public static Message info(String message, Object data) {
		return new Message(Type.info, message, data);
	}
